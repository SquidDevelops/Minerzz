...
public class RenderChunk {
    ...
    public void update(int[] chunk, int chunkX, int chunkZ){
        ...
        for(int i = 0; i < iSize; i++){
            chunkI[i] = i;
            //System.out.print(chunkI[i] + ", ");
        }

        /*for(int i = 0; i < chunkI.length; i++){ ;
            System.out.print(chunkI[i] + ", ");
        }*/
    ...
    public float[] getTexCoords(){
        ...
        for(int i = 0; i < fTexCoords.length/12; i++){
            System.arraycopy(texCoords, 0, fTexCoords, 12*i, 12);
        }
        return fTexCoords;
    }
